...
const BUILTIN_TYPES = ['Incline Treadmill', 'Walking Incline Treadmill', 'Treadmill', 'Stairmaster', 'Running', 'Walking', 'Assault Bike', 'Other']
...
function getDistanceUnit(type) {
  if (['Running', 'Walking', 'Treadmill', 'Incline Treadmill', 'Walking Incline Treadmill'].includes(type)) return 'miles'
